...
export { classifyInboundRequest } from '@modelcontextprotocol/core-internal/server-runtime';

// Cache hints for cacheable 2026-07-28 results (ServerOptions.cacheHints and
// the registerResource cacheHint option).
export type { CacheHint, CacheScope } from '@modelcontextprotocol/core-internal/server-runtime';
...
export type { ElicitInputParams, InputRequiredSpec, InputResponseView } from '@modelcontextprotocol/core-internal/server-runtime';
export { acceptedContent, inputRequired, inputResponse } from '@modelcontextprotocol/core-internal/server-runtime';
